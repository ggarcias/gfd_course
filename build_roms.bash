...
#export   ROMS_APPLICATION=RAFINA_REF
export   ROMS_APPLICATION=RAFINA_FORECAST
...
# to the code and inputs on differing machines.
 ...
 export        MY_ROMS_SRC=${ROMS_ROOT}/src/trunk
...
export        WRF_SRC_DIR=${HOME}/ROMS/src/tags/roms-3.6/Atmosphere/WRF
...
#--------------------------------------------------------------------------
export USE_HDF5=on
 export USE_MY_LIBS=on            # use system default library paths
